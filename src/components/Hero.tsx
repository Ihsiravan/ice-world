...
export function Hero({ onGetStarted }: HeroProps) {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto mb-8 mt-32">
        <div className="animate-fade-up">
          
          <h1 className="text-3xl md:text-5xl font-serif font-bold mb-6 leading-tight">
            <span className="gradient-text">Moments</span>
            <br />
            <span className="text-foreground">Across Miles</span>
          </h1>
          
          <p className="text-base md:text-lg text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed mt-4">
          ...
          <div className="flex justify-center items-center mb-8">
            <Button 
              ...
              className="animate-scale-in group relative overflow-hidden transition-all duration-500 hover:scale-110 hover:shadow-2xl hover:shadow-primary/25"
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-primary/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-lg" />
